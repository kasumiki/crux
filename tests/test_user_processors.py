...
from crux.processors import _load_user_processors, discover_processors
...
class TestUserProcessorLoading:
    ...
    def test_user_processors_dir_config_override(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("CRUX_USER_PROCESSORS_DIR", str(tmp_path))
        config.reload()

        from crux.processors import _get_user_processors_dir
